...
// Define the type for an individual restaurant item
...
const RestaurantDetailsScreen: React.FC = () => {
  const [details, setDetails] = useState<RestaurantItem[]>([]);
  ...
  useEffect(() => {
    const fetchRestaurantDetails = async () => {
      try {
        const q = query(collection(db, "restaurants"), where("restaurantType", "==", subTopic));
        const querySnapshot = await getDocs(q);
        const fetchedDetails: RestaurantItem[] = querySnapshot.docs.map((doc) => {
          const data = doc.data();
          return {
        ...
        // Initialize active image index for each restaurant
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.noDetailsContainer}>
          <Text style={styles.noDetailsText}>No restaurants available for {subTopic}.</Text>
        </View>
      </View>
    );
  }
              ...
              <View style={styles.infoContainer}>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.text}>
                    LKR {item.averagePrice} / ${convertToUSD(Number(item.averagePrice))}
                  </Text>
                </View>
                <View style={styles.infoRow}>
